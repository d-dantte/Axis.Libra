...
namespace Axis.Libra.URI
{
    ...
    public readonly struct InstructionNamespace
    {
        ...
        /// </summary>
        public static readonly Regex NamespacePattern = new Regex("^[a-zA-Z_\\-][\\w-]*(:[\\w-]+)*$");
        ...
        public static implicit operator InstructionNamespace(string value) => new InstructionNamespace(value);

...
namespace Axis.Libra.Request
{
    ...
    /// 
    /// </summary>
    public abstract class AbstractRequest<TResult>: IRequest<TResult>, IBinarySerializable
    {
        /// <summary>
        ...
        /// </para>
        /// <para>
        /// Note that his method excludes the <see cref="IRequest.InstructionURI"/> from the serialization to avoid endless recrussion.
        /// Implementations of this class having properties that depend on the <see cref="IRequest.InstructionURI"/> property are advised to override this method and exclude them from the serialization.
        /// </para>
        /// </summary>
        ...
        protected virtual byte[] Serialize() => PropertySerializer.Serialize(
            this,
            nameof(IRequest<TResult>.InstructionURI));
        ...
        /// </summary>
        public InstructionURI InstructionURI => new InstructionURI(Scheme.Request, this.InstructionNamespace(), Serialize());
